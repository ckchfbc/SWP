    ...
    <body>
        ...
        <script>
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    render: function (row) {
                                        ...
                                        if (!row.appointment_status) {
                                            html = '<button class="btn btn-danger remove-appointment" data-appointment-id="' + row.appointment_id + '">Remove</button>';
                                        } else {
                                            html = '<p class="text-success fw-bold m-0 p-0 fs-5">Done</p>';
                                        }
            ...
            $(document).on('click', '.remove-appointment', function () {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: 'Do you really want to remove this appointment?',
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response === true) {
                                    ...
                                    Swal.fire({
                                        title: 'Error!',
                                        text: 'Failed to remove the appointment. Please try again.',
                                        icon: 'error',
                                        confirmButtonText: 'OK'
                                    });
                                }
        ...
        <div class="container mt-5 pt-5">
            <a class="btn btn-primary mb-3" href="/AppointmentController/Create" target="_blank">Create Appointment</a>
