...
public class newCarModel {
    ...
    public int getFirst_car_image_id() {
        return first_car_image_id;
    }

    public void setFirst_car_image_id(int first_car_image_id) {
        this.first_car_image_id = first_car_image_id;
    }

    @Override
    public String toString() {
        return "newCarModel{" + "car_id=" + car_id + ", brand_id=" + brand_id + ", model_id=" + model_id + ", car_name=" + car_name + ", date_start=" + date_start + ", color=" + color + ", price=" + price + ", fuel_id=" + fuel_id + ", status=" + status + ", description=" + description + ", first_car_image_id=" + first_car_image_id + '}';
    }
